		...
		<div class="know-container" v-loading="loading">
			<div class="auditDaka">
				<div class="auditDaka-arrow">
					<router-link :to="{name: 'AnswerOrders'}">
						<i class="iconfont icon-guanbi"></i>
					</router-link>
					<font color="#666666">问答订单 / </font>
					<router-link :to="{name: 'AnswerOrders'}">
				...
				<div class="auditDaka-row">
					...
					<el-row :gutter="2" class="auditDaka-row-top">
						<el-col :span="12">
							<el-row :gutter="2">
								...
								<el-col :span="20">
									<div class="auditDaka-row-right">{{data.answer_type}}</div>
								</el-col>
							</el-row>
						</el-col>
						<el-col :span="12">
					...
					<el-row :gutter="2" class="auditDaka-row-top">
						...
						<el-col :span="12">
							<el-row :gutter="2">
								<el-col :span="4">
									<div class="auditDaka-row-left">付款者：</div>
								</el-col>
								<el-col :span="20">
					...
					<el-row :gutter="2" class="auditDaka-row-top">
						<el-col :span="12">
							<el-row :gutter="2">
								<el-col :span="4">
									<div class="auditDaka-row-left">问题状态 ：</div>
								</el-col>
								<el-col :span="20">
									<div class="auditDaka-row-right">{{data.answer_status}}</div>
								</el-col>
							</el-row>
						</el-col>
						<el-col :span="12">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async getData() {
				this.loading = true
				const data = await api.getAnswerOrderDetail(this.$route.params.id)
				this.data = data.data
				this.loading = false
			}
		},
