		...
		<div class="know-container" v-loading="loading">
			<div class="auditDaka">
				<div class="auditDaka-arrow">
					<router-link :to="{name: 'CancelsOrders'}">
						<i class="iconfont icon-guanbi"></i>
					</router-link>
					<font color="#666666">违约金订单 / </font>
					<router-link :to="{name: 'CancelsOrders'}">
				...
				<div class="auditDaka-row">
					<el-row :gutter="2" class="auditDaka-row-top">
						<el-col :span="24">
							<el-row :gutter="2">
								<el-col :span="2">
									<div class="auditDaka-row-left">话题名称 ：</div>
								</el-col>
								<el-col :span="22">
					...
					<el-row :gutter="2" class="auditDaka-row-top">
						...
						<el-col :span="12">
							<el-row :gutter="2">
								<el-col :span="4">
									<div class="auditDaka-row-left">申请者：</div>
								</el-col>
								<el-col :span="20">
					...
					<el-row :gutter="2" class="auditDaka-row-top">
						<el-col :span="12">
							<el-row :gutter="2">
								<el-col :span="4">
									<div class="auditDaka-row-left">收款者 ：</div>
								</el-col>
								<el-col :span="20">
									<div class="auditDaka-row-right">{{data.payee}}</div>
								</el-col>
							</el-row>
						</el-col>
						<el-col :span="12">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async getData() {
				this.loading = true
				const data = await api.getCancelsDetail(this.$route.params.id)
				this.data = data.data
				this.loading = false
			}
		},
