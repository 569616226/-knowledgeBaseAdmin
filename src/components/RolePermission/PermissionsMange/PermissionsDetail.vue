		...
		<div class="know-container" v-loading="loading">
			<div class="auditDaka">
				<div class="auditDaka-arrow">
					<router-link :to="{name: 'PermissionsMange'}">
						<i class="iconfont icon-guanbi"></i>
					</router-link>
					<font color="#666666">系统设置 / 权限管理 /  </font>
					<router-link :to="{name: 'PermissionsMange'}">
						<font color="#048aff">权限详情</font>
					</router-link>
				</div>
				...
				<div class="auditDaka-row">
					<el-row :gutter="2" class="auditDaka-row-top">
						<el-col :span="24">
							<el-row :gutter="2">
								<el-col :span="2">
									<div class="auditDaka-row-left">权限名称 ：</div>
								</el-col>
								<el-col :span="22">
									<div class="auditDaka-row-right">{{data.description}}</div>
								</el-col>
							</el-row>
						</el-col>
					</el-row>
