				...
				<div class="auditDaka-row">
					<el-row :gutter="2" class="auditDaka-row-top">
						<el-col :span="24">
							<el-row :gutter="2">
								<el-col :span="2">
									<div class="auditDaka-row-left">图片说明：</div>
								</el-col>
								<el-col :span="22">
					...
					<el-row :gutter="2" class="auditDaka-row-top">
						<el-col :span="12">
							<el-row :gutter="2">
								<el-col :span="4">
									<div class="auditDaka-row-left">轮播图片地址 ：</div>
								</el-col>
								<el-col :span="20">
									<div class="auditDaka-row-right">{{data.path}}</div>
								</el-col>
							</el-row>
						</el-col>
						<el-col :span="12">
							<el-row :gutter="2">
								<el-col :span="4">
									<div class="auditDaka-row-left">广告链接 ：</div>
								</el-col>
								<el-col :span="20">
									<div class="auditDaka-row-right">{{data.url}}</div>
								</el-col>
							</el-row>
						</el-col>
					</el-row>
					...
					<el-row :gutter="2" class="auditDaka-row-top">
						<el-col :span="24">
							<el-row :gutter="2">
								<el-col :span="2">
									<div class="auditDaka-row-left">广告图片：</div>
								</el-col>
								<el-col :span="22">
									<div class="auditDaka-row-right">
										<img :src="data.path" style="max-width: 60%;"/>
									</div>
								</el-col>
							</el-row>
						</el-col>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async getData() {
				this.loading = true
				const data = await api.getAdvertDetail(this.$route.params.id)
				this.data = data.data
				this.loading = false
			}
		},
